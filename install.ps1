...
function Deploy-ScoopByGithubMirrors
{
    ...
    if ($InstallBasicSoftwares)
    {
        ...
        # git软件资源
         ...
         Invoke-RestMethod -Uri $mirror/https://raw.githubusercontent.com/imic/scoop-industry/refs/heads/master/bucket/git.json -OutFile "$env:USERPROFILE\scoop\buckets\scoop-cn\bucket\git.json"
